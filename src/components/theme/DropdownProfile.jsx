    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium group-hover:text-slate-800">{userInfo?.name}</span>
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200">
            ...
            <div className="text-xs text-slate-500 italic">{userInfo?.role === 0 ? "Global" : "Your Company"}</div>
          </div>
          <ul>
            <li>
              <Link
