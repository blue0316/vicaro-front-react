...
function CreateProduct(props) {
    ...
    return (
        <>
            <div onClick={() => openModal()} className="font-medium text-sm text-slate-600 hover:text-blue-500 flex py-1 px-3 cursor-pointer hover:bg-gray-100">
                <FaRegEdit className="h-5 w-5 ml-1 mr-2
                " />
                Edit
            </div>
            <Modal
